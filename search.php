...
<input type="text" class="searchInput" placeholder="Start typing" value="<?php echo htmlspecialchars(
    $term,
); ?>" onfocus="var temp_val=this.value; this.value=''; this.value=temp_val" />
</div>
...
<div class="tracklistContainer borderBottom">
  ...
  while ($row = $result->fetch_assoc()) {
      ...
      echo "<li class='tracklistRow'>
          ...
          htmlspecialchars($albumSong->getId()) .
          "\", tempPlaylist, true)'>
          ...
          htmlspecialchars($albumSong->getTitle()) .
          "</span>
					<span class='artistName'>" .
          htmlspecialchars($albumArtist->getName()) .
          "</span>
				</div>
          ...
          "'>
				...
				<div class='trackDuration'>
					<span class='duration'>" .
          htmlspecialchars($albumSong->getDuration()) .
          "</span>
				</div>
			</li>";
 ...
 while ($row = $result->fetch_assoc()) {
     ...
     echo "<div class='searchResultRow'>
		<div class='artistName'>
         ...
         htmlspecialchars($artistFound->getId()) .
         "\")'>
			" .
...
<div class="gridViewContainer">
 ...
 while ($row = $result->fetch_assoc()) {
     echo "<div class='gridViewItem'>
         ...
         "\")'>
					<img src='" .
         htmlspecialchars($row["artworkPath"]) .
         "'>
